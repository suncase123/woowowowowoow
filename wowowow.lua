...
if isfile("StrategiesX/UserConfig/UtilitiesConfig.txt") then
  ...
  if type(getgenv().AutoRejoinLobby) == "boolean" then
      UtilitiesConfig.RejoinLobby = getgenv().AutoRejoinLobby
  end
...
if CheckPlace() then
	...
	UtilitiesTab:Toggle("Rejoin Lobby After Match", {flag = "RejoinLobby", default = UtilitiesConfig.RejoinLobby}, function(bool)
    StratXLibrary.RejoinLobby = bool -- Perbarui nilai
end)
